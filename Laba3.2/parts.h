...
public:
    ...
    public:
        Insert_Err()
        {
            Tree_Ex::inf = "Ошибка вставки: элемент с таким ключом уже существует!";
        }
    };
    ...
    public:
        Remove_Err()
        {
            Tree_Ex::inf = "Ошибка удаления: элемента с таким ключом не существует!";
        }
    };
    ...
    public:
        Find_Err()
        {
            Tree_Ex::inf = "Ошибка поиска: элемента с таким ключом не существует!";
        }
    };
};
