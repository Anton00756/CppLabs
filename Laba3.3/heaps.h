...
{
public:
	HeapInsertExc() { this->error = "Ошибка вставки!"; }
...
{
public:
	HeapGetMinExc() { this->error = "Минимум найти невозможно, так как куча пуста!"; }
	string text() override { return error; }
};
...
{
public:
	HeapDelMinExc() { this->error = "Удаление минимума невозможно, так как куча пуста!"; }
	string text() override { return error; }
};
